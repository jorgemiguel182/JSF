...
public abstract class BeanReportView extends BeanViewAbstract {
	...
	/* Protected pois apenas quem extender essa classe pode usar as vareiaveis */
	...
	protected String nomeRelatorioSaida = "dafault";

	@Resource
	private ReportUtil reportUtil;

	public BeanReportView() {
		parametrosRelatorios = new HashMap<Object, Object>();
	...
	public StreamedContent getArquivoReport() throws Exception {
		return getReportUtil().geraRelatorio(getListDataBeanCollectionReport(),
				getParametrosRelatorios(), getNomeRelatorioJasper(),
	...
	public void setParametrosRelatorios(
			HashMap<Object, Object> parametrosRelatorios) {
